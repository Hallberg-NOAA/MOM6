...
subroutine Neverworld_initialize_topography(D, G, param_file, max_depth)
  ...
  real :: x, y ! Lateral ositions normalized by the domain size [nondim]
...
subroutine Neverworld_initialize_thickness(h, depth_tot, G, GV, US, param_file, P_ref)
  ...
  real :: x, y    ! horizontal coordinates for computation of initial pert, normalized by the domain sizes [nondim]
  real :: r1, r2  ! radial coordinates for computation of initial pert, normalized by the domain sizes [nondim]
  ...
  real :: noise   ! Fractional oise in the layer thicknesses [nondim]
